...
from ..config import DEFAULT_DATABASE_SCHEMA, HMSConfig
...
app = typer.Typer(name="hms-admin", help="HMS administrative commands")
...
def backup(
    ...
    """Backup the HMS database to a zip file."""
