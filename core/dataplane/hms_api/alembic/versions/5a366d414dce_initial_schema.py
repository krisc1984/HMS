...
def _detect_vector_extension() -> str:
    ...
    Respects HMS_API_VECTOR_EXTENSION env var if set.
    """
    conn = op.get_bind()
    ...
    if vector_extension == "pgvector":
        ...
        return "pgvector"
    raise ValueError(
        "Invalid HMS_API_VECTOR_EXTENSION: "
...
def _detect_text_search_extension() -> str:
    ...
    Respects HMS_API_TEXT_SEARCH_EXTENSION env var.
    Creates the extension if needed.
    """
    text_search_extension = os.getenv("HMS_API_TEXT_SEARCH_EXTENSION", "native").lower()
    ...
    if text_search_extension == "vchord":
        ...
        raise ValueError(
            f"Invalid HMS_API_TEXT_SEARCH_EXTENSION: {text_search_extension}. Must be 'native', 'vchord', or 'pg_textsearch'"
        )
