...
def create_app(
    ...
    """
    Create and configure the unified HMS API application.
    ...
    if mcp_api_enabled:
        try:
            ...
            logger.error("Install with: pip install hms-api[mcp]")
            raise
    ...
    if http_api_enabled:
        ...
        app = FastAPI(title="HMS API", version="0.0.7")
