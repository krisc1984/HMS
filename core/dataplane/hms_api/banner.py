"""
Banner display for HMS API startup.
...
def print_banner():
    """Print the HMS startup banner."""
    print(LOGO)
    tagline = gradient_text("HMS: Agent Memory That Works Like Human Memory")
    print(f"\n  {tagline}\n")
...
def print_startup_info(
    ...
    print(color_start("Starting HMS API..."))
    if version:
