...
if TYPE_CHECKING:
    from hms_api.engine.db.base import DatabaseBackend
...
class ConfigResolver:
    ...
    def __init__(self, backend: "DatabaseBackend", tenant_extension: TenantExtension | None = None):
        ...
        self._configurable_fields = HMSConfig.get_configurable_fields()
        self._credential_fields = HMSConfig.get_credential_fields()

    async def resolve_full_config(self, bank_id: str, context: RequestContext | None = None) -> HMSConfig:
        """
        Resolve full HMSConfig for a bank with hierarchical overrides applied.
        ...
        Returns:
            Complete HMSConfig with hierarchical overrides applied
        """
        ...
        resolved_config = HMSConfig(**config_dict)
    ...
    async def update_bank_config(
        ...
        Args:
            ...
            updates: Dict of config field names to new values.
                    Keys can be in env var format (HMS_API_LLM_PROVIDER)
...
def apply_strategy(config: HMSConfig, strategy_name: str) -> HMSConfig:
    """
