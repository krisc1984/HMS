...
async def _find_related_observations(
    ...
    if is_tracing_enabled():
        recall_span = tracer.start_span("hms.consolidation_recall")
        recall_span.set_attribute("hms.bank_id", bank_id)
        recall_span.set_attribute("hms.query", query[:100])  # Truncate for brevity
        recall_span.set_attribute("hms.fact_type", "observation")
    else:
        recall_span = None
