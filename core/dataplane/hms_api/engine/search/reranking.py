...
class CrossEncoderReranker:
    ...
    async def rerank(self, query: str, candidates: list[MergedCandidate]) -> list[ScoredResult]:
        ...
        # Normalize scores if needed based on cross-encoder type.
        # Some rerankers (e.g., Qwen3-Reranker) output pre-normalized scores
        # in [0, 1] range, while others output raw logits that need sigmoid.
