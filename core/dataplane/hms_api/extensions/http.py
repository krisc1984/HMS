"""
HTTP Extension for adding custom endpoints to the HMS API.
...
class HttpExtension(Extension, ABC):
    ...
    Example:
        ```python
        from fastapi import APIRouter
        from hms_api.extensions import HttpExtension
    ...
    Configuration via environment variables:
        HMS_API_HTTP_EXTENSION=mypackage.ext:MyHttpExtension
