...
This extension allows external packages (like hms-cloud) to register
additional MCP tools on the HMS MCP server.

Example:
    HMS_API_MCP_EXTENSION=hms_cloud.extensions:CloudMCPExtension
"""
