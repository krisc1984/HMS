...
from hms_api.engine.llm_wrapper import create_llm_provider
...
@pytest.mark.asyncio
async def test_batch_api_normal_flow(mock_llm_config, test_contents, hms_config, memory, request_context):
...
@pytest.mark.asyncio
async def test_batch_api_crash_recovery(mock_llm_config, test_contents, hms_config, memory, request_context):
    ...
    try:
        ...
        from hms_api.engine.task_backend import fq_table
...
@pytest.mark.asyncio
async def test_batch_api_fallback_unsupported_provider(mock_llm_config, test_contents, hms_config):
    ...
    with patch(
        "hms_api.engine.retain.fact_extraction.extract_facts_from_contents"
...
async def test_batch_api_via_extract_facts_from_contents(
    mock_llm_config, test_contents, hms_config, memory, request_context
):
    ...
    try:
        ...
        hms_config.retain_batch_enabled = True
