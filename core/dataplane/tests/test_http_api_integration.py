"""
Integration test for the complete HMS API.
...
async def test_document_deletion_with_slashes_in_id(api_client):
    ...
    Regression test for https://github.com/hms-memory/hms/issues/92
...
async def test_version_endpoint_returns_correct_version(api_client):
    ...
    The version should match the __version__ defined in hms_api.__init__.py
