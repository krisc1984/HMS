...
Tests are skipped automatically if HMS_API_FILE_PARSER_IRIS_TOKEN
and HMS_API_FILE_PARSER_IRIS_ORG_ID are not set in the environment.
"""
...
from hms_api.config import ENV_FILE_PARSER_IRIS_ORG_ID, ENV_FILE_PARSER_IRIS_TOKEN
from hms_api.engine.parsers.iris import IrisParser
...
pytestmark = pytest.mark.skipif(
    ...
    reason="HMS_API_FILE_PARSER_IRIS_TOKEN and HMS_API_FILE_PARSER_IRIS_ORG_ID not set",
)

# Minimal valid PDF with the text "Hello from HMS"
...
<< /Length 44 >>
stream
BT /F1 12 Tf 100 700 Td (Hello from HMS) Tj ET
endstream
endobj
xref
0 5
