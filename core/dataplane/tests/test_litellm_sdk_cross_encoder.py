...
from hms_api.engine.cross_encoder import LiteLLMSDKCrossEncoder, create_cross_encoder_from_env
...
class TestFactoryFunction:
    ...
    async def test_create_litellm_sdk_from_env(self):
        ...
        env_vars = {
            "HMS_API_RERANKER_PROVIDER": "litellm-sdk",
            "HMS_API_RERANKER_LITELLM_SDK_API_KEY": "test_key",
            "HMS_API_RERANKER_LITELLM_SDK_MODEL": "deepinfra/Qwen3-reranker-8B",
        }
        ...
        with patch.dict(os.environ, env_vars, clear=False):
            ...
            with patch("hms_api.config.get_config", return_value=config):
    ...
    async def test_create_litellm_sdk_missing_api_key(self):
        ...
        with patch.dict(os.environ, env_vars, clear=False):
            ...
            if "HMS_API_RERANKER_LITELLM_SDK_API_KEY" in os.environ:
                del os.environ["HMS_API_RERANKER_LITELLM_SDK_API_KEY"]
            ...
            with patch("hms_api.config.get_config", return_value=config):
                with pytest.raises(ValueError, match="HMS_API_RERANKER_LITELLM_SDK_API_KEY is required"):
    ...
    async def test_create_litellm_sdk_with_custom_api_base(self):
        ...
        env_vars = {
            "HMS_API_RERANKER_PROVIDER": "litellm-sdk",
            "HMS_API_RERANKER_LITELLM_SDK_API_KEY": "test_key",
            "HMS_API_RERANKER_LITELLM_SDK_MODEL": "cohere/rerank-english-v3.0",
            "HMS_API_RERANKER_LITELLM_SDK_API_BASE": "https://custom.api.example.com",
        }
