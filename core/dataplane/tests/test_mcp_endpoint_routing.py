...
async def test_mcp_tool_execution_with_different_mcp_and_tenant_tokens(memory):
    ...
    Regression test for https://github.com/hms-memory/hms/issues/627
    When both HMS_API_MCP_AUTH_TOKEN and ApiKeyTenantExtension are configured
    ...
    from hms_api.api import create_app
    from hms_api.extensions import ApiKeyTenantExtension
    ...
    with patch("hms_api.api.mcp.MCP_AUTH_TOKEN", mcp_token):
        app = create_app(memory, mcp_api_enabled=True, initialize_memory=False)
