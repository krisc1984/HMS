...
from hms_api.engine.cross_encoder import RemoteTEICrossEncoder
...
class TestRemoteTEICrossEncoderConfig:
    ...
    def test_create_from_env(self):
        ...
        with patch.dict(
            os.environ,
            {
                "HMS_API_RERANKER_PROVIDER": "tei",
                "HMS_API_RERANKER_TEI_URL": "http://test:9000",
                "HMS_API_RERANKER_TEI_BATCH_SIZE": "256",
                "HMS_API_RERANKER_TEI_MAX_CONCURRENT": "16",
            },
        ):
    ...
    def test_create_from_env_with_custom_timeout(self):
        """Test that HMS_API_RERANKER_TEI_HTTP_TIMEOUT is respected."""
        import os
        ...
        with patch.dict(
            os.environ,
            {
                "HMS_API_RERANKER_PROVIDER": "tei",
                "HMS_API_RERANKER_TEI_URL": "http://test:9000",
                "HMS_API_RERANKER_TEI_HTTP_TIMEOUT": "120.0",
            },
        ):
            clear_config_cache()
            encoder = create_cross_encoder_from_env()
