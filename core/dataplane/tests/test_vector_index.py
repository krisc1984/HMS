...
from hms_api._vector_index import (
...
from hms_api.engine.retain import bank_utils
...
def test_alembic_vector_migrations_freeze_vector_sql_locally():
    migration_dir = Path(__file__).resolve().parent.parent / "hms_api/alembic/versions"
    changed_migrations = [
    ...
    for migration in changed_migrations:
        ...
        assert "hms_api._vector_index" not in text
