...
from hms_api.webhooks.manager import MAX_ATTEMPTS, RETRY_DELAYS, WebhookManager
from hms_api.webhooks.models import (
...
class _NonDefaultSchemaTenantExtension:
    ...
    async def authenticate(self, context):
        from hms_api.extensions import TenantContext
