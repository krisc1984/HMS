"""
Wrapper for HMS client that adds API namespaces.

Provides organized access to different parts of the HMS API through
...
class BanksAPI:
    ...
    def list(self) -> Any:
        ...
        """
        from hms_client.hms_client import _run_async
...
class HMSClient(HMS):
    """
    Enhanced HMS client with organized API namespaces.

    This wrapper extends the auto-generated HMS client with organized
    ...
    Example:
        ...
        client = HMSClient(base_url="http://localhost:8888")

        # Core operations (inherited from HMS)
