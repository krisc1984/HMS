...
def test_ensure_started_calls_manager(embedded_client):
    ...
    # Mock HMS client constructor
    with patch("hms.embedded.HMS") as mock_hms_class:
        mock_client = Mock()
        mock_hms_class.return_value = mock_client
        ...
        # Verify HMS client was created
        mock_hms_class.assert_called_once_with(base_url="http://localhost:54321")
