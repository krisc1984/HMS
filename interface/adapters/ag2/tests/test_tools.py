...
from hms_ag2.errors import HMSError


def _mock_client():
    """Create a mock HMS client with sync methods."""
    client = MagicMock()
...
class TestCreateHMSTools:
    ...
    def test_falls_back_to_global_config(self):
        ...
        with patch("hms_ag2._client.HMS") as mock_cls:
...
class TestRegisterHMSTools:
    ...
    def test_registers_with_docstring_descriptions(self):
        ...
        register_hms_tools(agent, executor, bank_id="test", client=client)
