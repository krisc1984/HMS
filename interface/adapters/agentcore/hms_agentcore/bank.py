...
Maps AgentCore invocation identity (tenant, user, agent) to a HMS bank ID
...
class BankResolver(Protocol):
    ...
    Implement this to customize how invocation identity maps to HMS bank IDs.
    """

    def __call__(self, context: TurnContext) -> str:
        """Resolve and return a HMS bank ID for the given context."""
        ...
