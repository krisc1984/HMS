"""Agno Toolkit for HMS memory operations.
...
try:
    _VERSION = metadata.version("hms-agno")
except metadata.PackageNotFoundError:
    _VERSION = "0.0.0"
_USER_AGENT = f"hms-agno/{_VERSION}"

_TOOL_INSTRUCTIONS = """\
You have access to long-term memory via HMS tools.
...
class HMSTools(Toolkit):
    """Agno Toolkit providing HMS memory tools.
