"""Unit tests for hms_agno configuration."""

import os
from unittest.mock import patch

from hms_agno import configure, get_config, reset_config
from hms_agno.config import (
    DEFAULT_HMS_API_URL,
    HMS_API_KEY_ENV,
    HMSAgnoConfig,
)
...
class TestHMSAgnoConfigDataclass:
...
class TestConfigure:
    ...
    def test_configure_returns_config_instance(self):
        config = configure()
        assert isinstance(config, HMSAgnoConfig)
