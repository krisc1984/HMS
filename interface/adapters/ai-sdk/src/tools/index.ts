...
/**
 * Nested based_on structure from HMS reflect
 */
...
/**
 * Mental model response from HMS
 */
...
/**
 * HMS client interface - matches @hms-memory/hms-client
 */
...
export interface HMSToolsOptions {
  /** HMS client instance */
  client: HMSClient;
...
/**
 * Creates AI SDK tools for HMS memory operations.
 *
 ...
 * ```
 */
export function createHMSTools({
  client,
  bankId,
  retain: retainOpts = {},
  recall: recallOpts = {},
...
export type HMSTools = ReturnType<typeof createHMSTools>;
