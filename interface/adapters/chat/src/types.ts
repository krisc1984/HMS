...
/**
 * Configuration for withHMSChat.
 */
export interface HMSChatOptions {
  /** HMS client instance. */
  client: HMSClient;
 ...
 */
export interface HMSChatContext {
...
/**
 * The handler signature that withHMSChat wraps.
 */
export type HMSChatHandler<TState = unknown> = (
