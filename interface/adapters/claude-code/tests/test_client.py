...
from lib.client import USER_AGENT, HMSClient, _validate_api_url
...
class TestHMSClientInit:
    def test_rejects_non_http_url(self):
        with pytest.raises(ValueError):
            HMSClient("ftp://bad")

    def test_stores_token(self):
        c = HMSClient("http://localhost:9077", api_token="tok123")
...
class TestHMSClientRecall:
    ...
    def test_includes_auth_header_when_token_set(self):
        c = HMSClient("http://localhost:9077", api_token="mytoken")
        captured = {}
    ...
    def test_sends_user_agent_header(self):
        ...
        assert captured["ua"].startswith("hms-claude-code/")
...
class TestHMSClientHealthCheck:
...
class TestHMSClientSetBankMission:
