...
Fires before each user prompt. Retrieves relevant memories from HMS
...
def main():
    ...
    try:
        ...
        print(f"[HMS] Recall failed: {e}", file=sys.stderr)
        return
...
if __name__ == "__main__":
    try:
        ...
        print(f"[HMS] Unexpected error in recall: {e}", file=sys.stderr)
        try:
