"""Global configuration for HMS-CrewAI integration."""
...
_global_config: HMSCrewAIConfig | None = None
...
def configure(
    ...
    Returns:
        The configured HMSCrewAIConfig.
    """
    ...
    _global_config = HMSCrewAIConfig(
...
def get_config() -> HMSCrewAIConfig | None:
