"""CrewAI Tool for HMS reflect operations.
...
class HMSReflectTool(BaseTool):
    ...
    Args:
        bank_id: The HMS memory bank to reflect against.
    ...
    hms_api_url: str | None = Field(default=None, description="Override API URL")
    ...
    def _get_client(self) -> Any:
        ...
        if client is None:
            ...
            config = get_config()
            api_url = self.hms_api_url or (config.hms_api_url if config else "http://localhost:8888")
    ...
    def _run(self, query: str) -> str:
        ...
        Raises:
            HMSError: If the reflect operation fails.
        """
