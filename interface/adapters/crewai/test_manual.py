"""Manual integration test for hms-crewai.

Prerequisites:
  1. HMS API running on localhost:8888 (./scripts/dev/start-api.sh)
...
from hms_crewai import HMSReflectTool, HMSStorage, configure
...
configure(hms_api_url=HMS_URL, verbose=True)
...
reflect_tool = HMSReflectTool(bank_id=BANK_ID, budget="mid")
...
recall_task = Task(
    description=(
        ...
        "Use the hms_reflect tool to check your memories."
    ),
