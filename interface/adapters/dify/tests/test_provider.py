"""Tests for HMSProvider credential validation."""
...
from provider.hms import HMSProvider


def _provider() -> HMSProvider:
    """Construct the provider without invoking the dify_plugin base init."""
    return HMSProvider.__new__(HMSProvider)
...
class TestValidateCredentials:
    ...
    def test_health_ok_with_key(self):
        with patch("provider.hms.requests.get") as mock_get:
