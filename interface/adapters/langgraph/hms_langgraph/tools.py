"""LangGraph tool definitions for HMS memory operations.

Provides factory functions that create LangGraph-compatible tool functions
backed by HMS's retain/recall/reflect APIs. These tools can be bound
...
def create_hms_tools(
    *,
    ...
    """Create HMS memory tools for a LangGraph agent.
