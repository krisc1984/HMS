...
hms-nemoclaw — Setup CLI for HMS memory on NemoClaw sandboxes
...
Required options:
  ...
  --api-url <url>        HMS Cloud API URL (https://api.hms.local)
  --api-token <token>    HMS API key from https://ui.hms.local
