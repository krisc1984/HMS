"""Global configuration for HMS-OpenAI-Agents integration."""
...
_global_config: HMSOpenAIAgentsConfig | None = None
...
def configure(
    ...
    Returns:
        The configured HMSOpenAIAgentsConfig.
    """
    ...
    _global_config = HMSOpenAIAgentsConfig(
...
def get_config() -> HMSOpenAIAgentsConfig | None:
