"""OpenAI Agents SDK tool definitions for HMS memory operations.

Provides factory functions that create OpenAI Agents SDK-compatible
``FunctionTool`` instances and dynamic instructions backed by HMS's
...
def create_hms_tools(
    *,
    ...
    """Create HMS memory tools for an OpenAI Agents SDK agent.
...
def memory_instructions(
    *,
    ...
    automatically recalls relevant memories from HMS and appends
    ...
    Example::
        ...
        from hms_openai_agents import memory_instructions, create_hms_tools
