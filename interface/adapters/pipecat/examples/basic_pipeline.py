"""Basic Pipecat pipeline with HMS persistent memory.

This example shows how to add long-term memory to a voice AI pipeline using
HMSMemoryService. The processor slots between the user context aggregator
and the LLM service — recalling relevant memories before each turn and retaining
conversation content after.

Requirements:
    pip install pipecat-hms pipecat-ai[deepgram,openai,cartesia,silero,daily]
...
Environment variables:
    ...
    HMS_API_URL    - HMS API URL (default: http://localhost:8888)
