"""Global configuration for HMS-Pydantic AI integration."""
...
_global_config: HMSPydanticAIConfig | None = None
...
def configure(
    ...
    Returns:
        The configured HMSPydanticAIConfig.
    """
    ...
    _global_config = HMSPydanticAIConfig(
...
def get_config() -> HMSPydanticAIConfig | None:
