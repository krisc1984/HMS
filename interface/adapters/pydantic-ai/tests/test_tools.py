"""Unit tests for HMS Pydantic AI tools."""

from unittest.mock import AsyncMock, MagicMock, patch

import pytest

from hms_pydantic_ai import (
    configure,
    create_hms_tools,
    memory_instructions,
    reset_config,
)
from hms_pydantic_ai.errors import HMSError
...
class TestCreateHMSTools:
    ...
    def test_falls_back_to_global_config(self):
        ...
        with patch("hms_pydantic_ai.tools.HMS") as mock_cls:
