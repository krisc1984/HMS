...
Persistent memory tools for [SmolAgents](https://github.com/huggingface/smolagents) agents via HMS. Give your agents long-term memory with retain, recall, and reflect — using SmolAgents' native Tool pattern.
...
```python
from hms_smolagents import create_hms_tools, memory_instructions
...
```python
from hms_smolagents import HMSRetainTool, HMSRecallTool
...
```python
from hms_smolagents import configure, create_hms_tools
