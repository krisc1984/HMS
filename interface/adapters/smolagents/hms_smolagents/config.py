"""Global configuration for HMS-SmolAgents integration."""
...
@dataclass
class HMSSmolAgentsConfig:
    """Connection and default settings for the SmolAgents integration.
...
_global_config: HMSSmolAgentsConfig | None = None
...
def configure(
    ...
    Returns:
        The configured HMSSmolAgentsConfig.
    """
    ...
    _global_config = HMSSmolAgentsConfig(
...
def get_config() -> HMSSmolAgentsConfig | None:
