"""Unit tests for hms_smolagents configuration."""

import os
from unittest.mock import patch

from hms_smolagents import configure, get_config, reset_config
from hms_smolagents.config import (
    DEFAULT_HMS_API_URL,
    HMS_API_KEY_ENV,
    HMSSmolAgentsConfig,
)
...
class TestHMSSmolAgentsConfigDataclass:
    def test_default_values(self):
        config = HMSSmolAgentsConfig()
...
class TestConfigure:
    ...
    def test_configure_returns_config_instance(self):
        config = configure()
        assert isinstance(config, HMSSmolAgentsConfig)
    ...
    def test_configure_url_defaults_when_none(self):
        config = configure(hms_api_url=None)
        assert config.hms_api_url == DEFAULT_HMS_API_URL
