...
Persistent memory tools for [Strands Agents SDK](https://github.com/strands-agents/sdk-python) agents via HMS. Give your agents long-term memory with retain, recall, and reflect — using Strands' native `@tool` pattern.
...
```python
from hms_strands import create_hms_tools, memory_instructions
...
```python
from hms_strands import configure, create_hms_tools
