"""Global configuration for HMS-Strands integration."""
...
_global_config: HMSStrandsConfig | None = None
...
def configure(
    ...
    Returns:
        The configured HMSStrandsConfig.
    """
    ...
    _global_config = HMSStrandsConfig(
...
def get_config() -> HMSStrandsConfig | None:
