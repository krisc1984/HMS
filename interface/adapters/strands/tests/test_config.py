"""Unit tests for hms_strands configuration."""

import os
from unittest.mock import patch

from hms_strands import configure, get_config, reset_config
from hms_strands.config import (
    DEFAULT_HMS_API_URL,
    HMS_API_KEY_ENV,
    HMSStrandsConfig,
)
...
class TestHMSStrandsConfigDataclass:
    def test_default_values(self):
        config = HMSStrandsConfig()
...
class TestConfigure:
    ...
    def test_configure_returns_config_instance(self):
        config = configure()
        assert isinstance(config, HMSStrandsConfig)
