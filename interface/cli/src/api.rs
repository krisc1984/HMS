//! API client wrapper
//!
//! This module provides a thin wrapper around the auto-generated hms-client
//! to bridge from the CLI's synchronous code to the async API client.

use anyhow::Result;
pub use hms_client::types;
use hms_client::{Client as AsyncClient, Error as ClientError};
...
// OpenAPI coverage. Enforced by `uv run cli-coverage-check` in lab/evaluation.
// ============================================================================
