/**
 * Shared HMS API client instance for the control plane.
...
export const DATAPLANE_URL = process.env.HMS_CP_DATAPLANE_API_URL || "http://localhost:8888";
const DATAPLANE_API_KEY = process.env.HMS_CP_DATAPLANE_API_KEY || "";
...
/**
 * Export HMSError for error handling
 */
export { HMSError };
