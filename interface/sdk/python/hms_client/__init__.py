"""
HMS Client - Clean, pythonic wrapper for the HMS API.

This package provides a high-level ``HMS`` class with simplified methods
...
clients exposed as properties on the ``HMS`` instance (e.g.
...
from hms_client_api.models.recall_response import RecallResponse as _RecallResponse
from hms_client_api.models.recall_result import RecallResult as _RecallResult
...
def _recall_response_to_prompt_string(self) -> str:
    ...
    This mirrors the format used internally by HMS's reflect operation.
    """
    import json
