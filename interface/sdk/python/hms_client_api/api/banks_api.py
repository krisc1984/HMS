...
from hms_client_api.rest import RESTResponseType
...
class BanksApi:
    ...
    async def update_bank_config(
        ...
        Update configuration overrides for a bank. Only hierarchical fields can be overridden (LLM settings, retention parameters, etc.). Keys can be provided in Python field format (llm_provider) or environment variable format (HMS_API_LLM_PROVIDER).
