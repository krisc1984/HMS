...
class AuditLogStatsResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AuditLogStatsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AuditLogStatsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "trunc": obj.get("trunc"),
            "start": obj.get("start"),
            "buckets": [AuditLogStatsBucket.from_dict(_item) for _item in obj["buckets"]] if obj.get("buckets") is not None else None
        })
        return _obj
