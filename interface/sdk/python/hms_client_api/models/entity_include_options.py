...
class EntityIncludeOptions(BaseModel):
    ...
    """ # noqa: E501
    max_tokens: Optional[StrictInt] = Field(default=500, description="Maximum tokens for entity observations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "max_tokens": obj.get("max_tokens") if obj.get("max_tokens") is not None else 500
        })
        return _obj
