...
# Test configuration
HMS_API_URL = os.getenv("HMS_API_URL", "http://localhost:8888")


@pytest.fixture
def client():
    """Create a HMS client for testing."""
    with HMS(base_url=HMS_API_URL) as client:
        yield client
...
class TestBankStats:
    ...
    async def test_get_bank_stats(self, client, bank_id):
        ...
        from hms_client_api import ApiClient, Configuration
        from hms_client_api.api import BanksApi

        config = Configuration(host=HMS_API_URL)
...
class TestOperations:
    ...
    async def test_list_operations(self, client, bank_id):
        ...
        from hms_client_api import ApiClient, Configuration
        from hms_client_api.api import OperationsApi
...
class TestDocuments:
    ...
    def test_delete_document(self, client, bank_id):
        ...
        from hms_client_api import ApiClient, Configuration
        from hms_client_api.api import DocumentsApi
...
class TestEntities:
    ...
    def test_list_entities(self, client, bank_id):
        ...
        from hms_client_api import ApiClient, Configuration
        from hms_client_api.api import EntitiesApi
