...
impl ApiClient {
    pub fn new(base_url: String) -> Result<Self> {
        ...
        let client = hms_client::Client::new(&base_url);
        Ok(ApiClient { client, runtime })
    }

    pub fn list_agents(&self) -> Result<Vec<hms_client::types::AgentListItem>> {
...
async fn main() -> Result<()> {
    let cli = Cli::parse();
    let client = hms_client::Client::new(&config.api_url);
...
The generated types are in `hms_client::types::*`. Here's the mapping:
