...
Auto-generated Rust client library for the HMS semantic memory system API.
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Search memories
    let search_request = hms_client::types::SearchRequest {
    ...
    // Store a memory
    let memory_request = hms_client::types::BatchMemoryRequest {
        items: vec![
            hms_client::types::MemoryItem {
...
└── target/
    └── debug/build/
        └── hms-client-.../out/
            └── hms_client_generated.rs  # Generated code
```
