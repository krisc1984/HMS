# HMS TypeScript Client

TypeScript client library for the HMS API.

## Installation

```bash
npm install @hms-memory/hms-client
# or
yarn add @hms-memory/hms-client
```
...
For full documentation, visit [hms](https://github.com/hms-memory/hms).
