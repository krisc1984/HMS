...
knowledge/site/static/bank-template-schema.json.
"""
...
def generate_bank_template_schema(output_path: str | None = None) -> None:
    ...
    if output_path is None:
        # Default to knowledge/site/static/bank-template-schema.json
        root_dir = Path(__file__).resolve().parents[3]
        output_path = str(root_dir / "knowledge" / "site" / "static" / "bank-template-schema.json")
