...
Usage: generate-llms-full (after installing lab/evaluation)

Output: knowledge/site/static/llms-full.txt (served at /llms-full.txt)
"""
...
def get_docs_dir() -> Path:
    """Find the docs directory relative to the repository root."""
    return get_repo_root() / "knowledge" / "site" / "docs"


def get_output_file() -> Path:
    """Get output file path."""
    return get_repo_root() / "knowledge" / "site" / "static" / "llms-full.txt"
...
def main():
    ...
    sections.append(f"""# HMS Documentation

> Agent Memory that Works Like Human Memory

This file contains the complete HMS documentation for LLM consumption.
Generated: {timestamp}
