/**
 * HMS Agent SDK — harness-agnostic knowledge tools.
 *
 * Provides agent_knowledge_* tool definitions that any harness can register.
 * Uses @hms-memory/hms-client for all API calls.
 */
  ...
  const lowLevel = createClient(
    createConfig({
      ...
      headers: {
        ...
        "User-Agent": "hms-agent-sdk/0.1.0",
      },
    })
  );
